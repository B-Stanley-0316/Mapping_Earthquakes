...
majorEQData = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson"
...
let myStyle = {
  ...
  d3.json(tectonicData).then(function(plateData) {
